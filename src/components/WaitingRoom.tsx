            ...
            <div className="p-4 space-y-4">
              ...
              {isHost ? (
                <Button
                  ...
                  className="w-full h-12 bg-red-500 hover:bg-red-600 border-2 border-black text-white mt-4"
                >
                  <Play className="w-5 h-5 mr-2" />
                  Start Game
                </Button>
              ) : (
                <div className="text-center text-sm text-black/60 py-4 border-2 border-black rounded-lg mt-4">
